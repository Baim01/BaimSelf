...
╔═══════════════════
║             ✡  ㄅꀤngŁҾ ㉿ꀤŁŁҾr  ✡
║          𖤓≛≛≛≛≛ᴄ̷̥̥ᴏ̷̥̥ʟ̷̥̥ᴅ̷̥̥ ̷̥̥ᴋ̷̥̥ɪ̷̥̥ʟ̷̥̥ʟ̷̥̥ᴇ̷̥̥ʀ̷̥̥≛≛≛≛≛𖤓
║                ✯===[C̶̲̅ᴏ̶̲̅ᴍ̶̲̅ᴍ̶̲̅ᴀ̶̲̅ɴ̶̲̅ᴅ̶̲̅]===✯
║                         ᴄᴏɴғɪɢ ʙᴏᴛs
║               ✴ρ̴̴̶̴̴̶̴̴υ̴̴̶̴̴̶̴̴в̴̴̶̴̴̶̴̴Ꮮ̴̴̶̴̴̶̴̴ι̴̴̶̴̴̶̴̴Ꮯ̴̴̶̴̴ ̴̴̶̴̴Ꮯ̴̴̶̴̴̶̴̴ø̴̴̶̴̴̶̴̴м̴̴̶̴̴̶̴̴м̴̴̶̴̴̶̴̴α̴̴̶̴̴̶̴̴ɴ̴̴̶̴̴̶̴̴δ̴̴̶̴✴
║✪╔═════════════════        
║✪╠➣ Help
║✪╠➣ Creator
║✪╠➣ Gcreator 
...
║✪╠➣ Sk out
║✪╠═════════════════
║✪║     ʜᴛᴛᴘ://ʟɪɴᴇ.ᴍᴇ/ᴛɪ/ᴘ/ғxsғᴀᴍɪʟɪᴀ
║✪╚═════════════════
╚═══════════════════
      By Baim Single Killer
"""
...
#-----------------------------------------------
                ...
                wait["AutoJoin"] = True
                baim.sendText(msg.to,"Join Active")

            elif msg.text in ["Join off","join off"]:
                wait["AutoJoin"] = False
                baim.sendText(msg.to,"Join inActive")
...
#--------------------------------------------------------
		...
		#==================================================================
	        ...
	        wait["Qr"] = True
	    	baim.sendText(msg.to,"QR Protect Active")

	    elif "Qr off" in msg.text:
	    	wait["Qr"] = False
	    	baim.sendText(msg.to,"Qr Protect inActive")
#--------------------------------------------------------
...
#--------------------------------------------------------
		...
		if wait["Contact"] == True: md+="✔ Info Contact : on\n"
                ...
                if wait["Cancel"] == True:md+="✔ cancel  on\n"
                else: md+= "❌ cancel : off\n"
		if wait["Qr"] == True: md+="✔ Qr Protect  on\n"
		else:md+="❌ Qr Protect : off\n"
		if wait["Kick"] == True: md+="✔ kick  on\n"
		else:md+="❌ kick : off"
                alin.sendText(msg.to,"===[SτλτƲȘ ㄅ㉿ ßΘτ]===\n"+md)
#--------------------------------------------------------
...
#--------------------------------------------------------
		...
		baim.sendText(msg.to,"☬Sᴜᴄᴄᴇss Aᴅᴅ ᴀʟʟ☬")
#--------------------------------------------------------
		...
		baim.sendText(msg.to,"☬SƲȻȻεȘȘ રεȻΘνεર☬")
#--------------------------------------------------------
	    elif msg.text in ["Remove chat"]:
		baim.removeAllMessages(op.param2)
		baim.sendText(msg.to,"Removed all chat")
#--------------------------------------------------------
            elif ("Gn " in msg.text):
                if msg.toType == 2:
                    X = baim.getGroup(msg.to)
...
#--------------------------------------------------------
		...
		if midd not in admin:
		    ...
		    baim.sendText(msg.to,"☬Æðm¡ñ Ð€t€¢t€ð☬")
#--------------------------------------------------------
...
#--------------------------------------------------------
                ...
                gs = baim.getGroup(msg.to)
                baim.sendText(msg.to,"Selamat datang di "+ gs.name)
#-----------------------------------------------
...
#--------------------------------------------------------
		...
		gid = baim.getGroupIdsJoined()
		for i in gid:
		    baim.sendText(i,"=======[ßŔ♡ΛDƇΛSŦ]=======\n\n"+bc+"\n")
		baim.sendText(msg.to,"☬ѕυ¢¢єѕ в¢ вσѕq☬")
#--------------------------------------------------------
...
#--------------------------------------------------------
		...
		try:
		    ...
		    baim.comment(url['result']['posts'][0]['userInfo']['mid'], url['result']['posts'][0]['postInfo']['postId'], "Auto like by: http://line.me/ti/p/~fxsfamilia")
		    baim.sendText(msg.to, "☬ѕυꁊꁊꂅѕѕ☬")
		except Exception as E:
		    try:
...
#--------------------------------------------------------
                ...
                baim.sendText(msg.to,"☬ㄅҾnd C㊉NŦACŦ☬")
...
#-----------------------------------------------
              ...
              if msg.toType == 2:
                    ...
                    try:
                        ...
                        gCreator = "Error"
                    baim.sendText(msg.to, "Group Creator : " + gCreator1)
                    baim.sendMessage(msg)
                    #-----------------------
		...
		for contact in group.members:
			...
			baim.sendText(msg.to, "☬sᴜᴄᴄᴇss☬")
		    else:
			pass
		
		                    #-----------------------
	    elif "Sk clone " in msg.text:
...
#-----------------------------------------------
				...
				baim.sendText(msg.to,"☬ㄅ㉿ ᎠᎬͲᎬ¢ͲᎬᎠ☬")
#--------------------------------------------------------
                ...
                if wait["blacklist"] == {}:
                    ...
                    baim.sendText(msg.to,"===[☬вℓα¢кℓιѕт υѕєя☬]===\n"+mc)
...
#--------------------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    baim.sendText(msg.to,"☬BLACҞLISŦ EMANG PANŦAS ŦUҞ ÐI USIR☬")
#--------------------------------------------------------
            elif "l love you" in msg.text:
                if msg.toType == 2:
                    print "I love you too"
                    _name = msg.text.replace("I love you","")
                    gs = baim.getGroup(msg.to)
                    baim.sendText(msg.to,"šεε ψ⊕u αgαïη")
                    targets = []
                    for g in gs.members:
...
#Restart_Program
		       ...
		       baim.sendText(msg.to, "☬вσт нαѕ вєєи яєѕтαятє∂☬")
		       restart_program()
		       print "@Restart"
#--------------------------------------------------------
#-----------------------------------------------             
...
while True:
    try:
        Ops = baim.fetchOps(alin.Poll.rev, 5)
    except EOFError:
        raise Exception("It might be wrong revision\n" + str(alin.Poll.rev))

    for Op in Ops:
        if (Op.type != OpType.END_OF_OPERATION):
            baim.Poll.rev = max(alin.Poll.rev, Op.revision)
            bot(Op)
